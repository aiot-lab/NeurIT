...
WINDOW_SIZE = 200 # Window size for training and testing (ronin: 400; ridi: 200; neurit: 200)
...
SAMPLING_RATE = 200 # Sampling rate (ronin: 200; ridi: 200; neurit: 100)
USE_MAGNETOMETER = True # Use magnetometer for drift compensation or not
USE_ANGMENTATION = True # Use orientation angmentation or not
...
LEARNING_RATE = 0.0003 # Learning rate (ronin: 0.0002, ridi: 0.0002, neurit: 0.00003)
NUM_WORKERS = 8
### ------------------ ###
...
OUT_DIR = './prediction_model/neurit/test1' # Output directory for both traning and testing. For training, the output directory will save the model weights. For testing, the output directory will save the prediction results.
